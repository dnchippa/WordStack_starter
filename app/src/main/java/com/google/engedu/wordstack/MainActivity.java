...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onStartGame(View view) {
        ...
        int n1 = random.nextInt(words.size());
        word1=words.get(n1);
        int n2;
        do{
            n2 = random.nextInt(words.size());
            word2=words.get(n2);
        }while(n1==n2);
        int i,j;
        scrambledWord="";
        ...
        for(i=0,j=0;i< word1.length() && j < word2.length();){
            ...
            if(ran && count1 < 3 ) {
                scrambledWord = scrambledWord.concat(String.valueOf(word1.charAt(i)));
                count1++;
                count2=0;
                i++;
            }else if(count2 < 3) {
                scrambledWord = scrambledWord.concat(String.valueOf(word2.charAt(j)));
                count2++;
                count1=0;
                j++;
            }
        ...
        for(i=scrambledWord.length()-1;i>=0;i--)
        ...
        if(!placedTiles.isEmpty())
            {
                ...
                poppedTile.moveToViewGroup((ViewGroup) stackedLayout);
            }
        return true;
    }
}
